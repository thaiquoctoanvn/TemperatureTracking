    ...
    companion object {
        ...
        fun getMemberInfo(): MutableList<Member> {
            return mutableListOf(
                Member("Vũ Quốc Minh (MChs)", "https://scontent-sin6-2.xx.fbcdn.net/v/t1.0-9/106350725_1775530575920767_7803104528657020398_o.jpg?_nc_cat=102&ccb=2&_nc_sid=09cbfe&_nc_ohc=06qjpEfBA44AX8WUTw1&_nc_ht=scontent-sin6-2.xx&oh=741dac5caf5c0db3dc3cca5f46a1c405&oe=5FDFF06A"),
